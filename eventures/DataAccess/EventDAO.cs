...
namespace eventures.DataAccess
{
    public class EventDAO
    {
        public void CreateEvent(Event eventObj)
        {
            ...
            {
                string query = "INSERT INTO Events (EventName, Description, EventDate, Location, Capacity, Category, CreatorID, CreatedDate) " +
                               "VALUES (@EventName, @Description, @EventDate, @Location, @Capacity, @Category, @CreatorID, @CreatedDate)";
